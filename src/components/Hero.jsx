      ...
      <div className="container hero-container">
        <div className="hero-content">
          ...
          <p className="hero-description">
            I am a software developer and community leader dedicated to building technology that solves real-world problems. 
            From cognitive accessibility to environmental impact.
          </p>
